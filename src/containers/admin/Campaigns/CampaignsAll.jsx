...
import { FILTERS, ACCESS_TOKEN, API_MARKETING } from '../../../constants';
...
const CampaignsAll = (props) => {
  ...
  // const [apiMostRecentResponse, setApiMostRecentResponse] = useState({});
        ...
        <div className="campaignleftSideBar">
          ...
          <div className="folder">
            <div className="campaign__folder__filters__left">
              {folderResponse.length > 0
                ? (
                  <>
                    <ArrowDropDownIcon className="arrow-cls" />
