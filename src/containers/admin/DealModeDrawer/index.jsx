      ...
      <div className="drawer">
        <div className="innerDrawerCon">
          ...
          <div className="deal-category">
            ...
            <Divider />
            { deal?.dmElements?.map((dmElement) => {
              const { id, dealElement, dmElementsDocs } = dmElement;
                          ...
                          <div className="deal-category__title">{dealElement.name}</div>
                          {
                            ...
                            && (
                              <div className="deal-category__title">
                                {
                                  (dmElementsDocs.length > 0 && (dealElement.name === 'Quote' || dealElement.name === 'Purchase Order'))
                                    ? (
                                      <div
                                        className="pointer"
                                        onClick={
                                          () => createDealElement(id, name)
                                        }
                                      >
                                        Create
                                      </div>
                        ...
                        >
                          ...
                          <div className="document__details">
                            ...
                            <div
                              ...
                              onClick={() => window.open(`${GOOGLE_STORAGE}${doc.gcsFilename}`, '_target')}
                            >
                              Preview
                            </div>
                          </div>
